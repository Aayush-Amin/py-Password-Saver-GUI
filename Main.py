...
class MyWindow(QMainWindow):
    ...
    def update(self):
        ...
        outFile=open('C:/Users/Aayush Amin/Desktop/Projects/Password Secure/passwordData.txt','r')
    ...
    def resetdata(self):
        file1=open('C:/Users/Aayush Amin/Desktop/Projects/Password Secure/savedPassword.txt','r+')
        file1.truncate(0)
        file1.close()
        
        file2=open('C:/Users/Aayush Amin/Desktop/Projects/Password Secure/passwordData.txt','r+')
        file2.truncate(0)
        file2.close()
        sys.exit()
    ...
    def readsaves(self):
        self.mainFile=open('C:/Users/Aayush Amin/Desktop/Projects/Password Secure/savedPassword.txt','r')
